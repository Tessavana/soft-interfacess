...
var portfolioItemClick = function() {
    $('.portfolio-item').on('click', function(e) {
        var href = $(this).attr('href'); // Get the href of the clicked item (should point to the specific project page)

        if (href) {
            window.location.href = href;  // Navigate to the specific project page
        }

        e.preventDefault();  // Prevent default behavior to ensure navigation
    });
	// Close
